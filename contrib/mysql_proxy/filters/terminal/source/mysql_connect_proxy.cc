...
Config::WeightedClusterEntry::WeightedClusterEntry(
    const Config& parent, const envoy::extensions::filters::network::mysql_connect_proxy::v3::MySQLConnectProxy::
...
Config::Config(const envoy::extensions::filters::network::mysql_connect_proxy::v3::MySQLConnectProxy& config,
               Server::Configuration::FactoryContext& context)
  ...
  if (default_route_ == nullptr && config.has_weighted_clusters()) {
    ...
    for (const envoy::extensions::filters::network::mysql_connect_proxy::v3::MySQLConnectProxy::WeightedCluster::
...
Network::FilterStatus Filter::onNewConnection() {
  ENVOY_CONN_LOG(trace, "mysql_connect_proxy: onNewConnection() called", read_callbacks_->connection());
