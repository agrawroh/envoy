...
/**
 * MySQL proxy stats for on-demand. These stats are generated only if the MySQL proxy enables on demand.
 */
...
public:
  TunnelingConfigHelperImpl(
      const envoy::extensions::filters::network::mysql_connect_proxy::v3::MySQLConnectProxy_TunnelingConfig&
          config_message,
...
public:
  OnDemandConfig(const envoy::extensions::filters::network::mysql_connect_proxy::v3::MySQLConnectProxy_OnDemand&
                     on_demand_message,
...
public:
  ...
  class SharedConfig {
  public:
    SharedConfig(const envoy::extensions::filters::network::mysql_connect_proxy::v3::MySQLConnectProxy& config,
                 Server::Configuration::FactoryContext& context);
  ...
  Config(const envoy::extensions::filters::network::mysql_connect_proxy::v3::MySQLConnectProxy& config,
         Server::Configuration::FactoryContext& context);
...
// connection has been closed. The MySQLConnectProxy is destroyed when the downstream connection is closed,
