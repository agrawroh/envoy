...
.. csv-table::
  ...
  on_route_duration, Histogram, Time the module spent deciding, in microseconds.
  specifier_duration, Histogram, Time the specifier spent on a request, in microseconds.
