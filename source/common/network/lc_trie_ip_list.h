...
/**
 * High-performance IP address range matcher using LC Trie for O(log n) lookups.
...
class LcTrieIpList {
public:
  static absl::StatusOr<std::unique_ptr<LcTrieIpList>>
...
private:
  LcTrieIpList(const Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange>& cidrs);
  LcTrieIpList(const Protobuf::RepeatedPtrField<xds::core::v3::CidrRange>& cidrs);
