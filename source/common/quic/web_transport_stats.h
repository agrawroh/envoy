...
// peer of the http3 codec scope. sessions_total counts accepted sessions and sessions_rejected
// counts sessions refused by the per-connection limit. @see stats_macros.h
