...
AdminImpl::AdminImpl(const std::string& profile_path, Server::Instance& server,
    ...
    : server_(server), listener_info_(std::make_shared<ListenerInfoImpl>()),
      ...
      no_op_store_(server_.stats().rootScope()->symbolTable()),
      ...
      reverse_tunnels_handler_(server), runtime_handler_(server), listeners_handler_(server),
      ...
      handlers_{
          ...
          makeHandler(
              "/reverse_tunnels", "display reverse tunnel connection information",
              MAKE_ADMIN_HANDLER(reverse_tunnels_handler_.handlerReverseTunnels), false, false,
              {{Admin::ParamDescriptor::Type::String, "node_id", "Filter by specific node ID", {}},
               {Admin::ParamDescriptor::Type::String,
                "cluster_id",
               ...
               {Admin::ParamDescriptor::Type::Enum,
                "format",
                "Output format",
                {"json", "text", "prometheus"}},
               {Admin::ParamDescriptor::Type::Boolean,
                "include_metadata",
                "Include detailed connection metadata",
                {}},
               {Admin::ParamDescriptor::Type::String,
                "since",
                "Show connections established since timestamp (ISO8601)",
                {}},
               {Admin::ParamDescriptor::Type::Boolean,
                "healthy_only",
               ...
               {Admin::ParamDescriptor::Type::String,
                ...
                {"node_id", "cluster_id", "established_time", "last_activity", "ping_latency",
                 "failures"}},
               {Admin::ParamDescriptor::Type::Boolean, "desc", "Sort in descending order", {}},
               {Admin::ParamDescriptor::Type::String,
                "filter",
                "Regular expression (Google re2) for filtering connections",
                {}},
               {Admin::ParamDescriptor::Type::String,
                "health",
               ...
               {Admin::ParamDescriptor::Type::String,
                "until",
                "Show connections established until timestamp (ISO8601)",
                {}},
               {Admin::ParamDescriptor::Type::String,
                "offset",
                "Skip first N connections for pagination",
                {}},
               {Admin::ParamDescriptor::Type::Boolean,
                "aggregate_only",
               ...
               {Admin::ParamDescriptor::Type::String,
                "limit",
                "Limit number of connections returned",
                {}}}),
      },
