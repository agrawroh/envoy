...
InstanceImpl::InstanceImpl(const Options& options, Network::Address::InstanceConstSharedPtr local_address,
    ...
    : options_(options), api_(api), http_context_(http_context), grpc_context_(grpc_context),
      ...
      validation_context_(validation_context), local_info_(node, local_address, options.serviceZone(),
                                                         options.serviceClusterName(),
                                                         options.serviceNodeName()),
      access_log_manager_(log_manager), lifecycle_notifier_(lifecycle_notifier),
      thread_local_(tls), file_system_(file_system), random_generator_(random_generator),
      bootstrap_(bootstrap), stats_(store), ssl_context_manager_(ssl_context_manager),
