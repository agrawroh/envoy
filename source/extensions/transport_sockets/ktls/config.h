 ...
 */
class KtlsTransportSocketConfigFactory
 ...
 */
class KtlsClientTransportSocketConfigFactory
 ...
 */
class KtlsServerTransportSocketConfigFactory
    : public KtlsTransportSocketConfigFactory,
      public Server::Configuration::DownstreamTransportSocketConfigFactory {
public:
  absl::StatusOr<Network::DownstreamTransportSocketFactoryPtr>
  createTransportSocketFactory(const Protobuf::Message& message,
