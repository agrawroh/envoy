...
public:
  ...
  // tcp_proxy that wants to splice() on the fd. Without this forward the base default reports "not
  // kTLS" and the L4 splice fast-path never engages on a wrapped upstream.
