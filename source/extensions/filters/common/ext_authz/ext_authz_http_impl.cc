...
ClientConfig::ClientConfig(
    ...
    : client_header_matchers_(toClientMatchers(
      ...
      failure_debugging_allowed_(false), cluster_name_(http_service.server_uri().cluster()),
      timeout_(timeout), path_prefix_(THROW_OR_RETURN_VALUE(
                             validatePathPrefix(http_service.path_prefix()), std::string)),
