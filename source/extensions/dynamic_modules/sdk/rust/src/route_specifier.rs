...
/// defines and records custom metrics scoped to that configuration. The declarations can only be
/// read while the configuration is being created, and metrics can be recorded at any point.
///
