// Comprehensive tests for LC Trie-enhanced IPMatcher in RBAC.
...
class LcTrieIPMatcherTest : public testing::Test {
protected:
...
TEST_F(LcTrieIPMatcherTest, SingleRangeConstructorConnectionRemote) {
...
TEST_F(LcTrieIPMatcherTest, SingleRangeConstructorIPv6) {
...
TEST_F(LcTrieIPMatcherTest, MultipleRangesCreate) {
...
TEST_F(LcTrieIPMatcherTest, AllMatcherTypesMatching) {
  auto range = createCidrRange("192.168.1.0", 24);
...
TEST_F(LcTrieIPMatcherTest, EmptyRangeListError) {
...
TEST_F(LcTrieIPMatcherTest, InvalidSingleRangeError) {
...
TEST_F(LcTrieIPMatcherTest, InvalidMultipleRangesError) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> ranges;
...
TEST_F(LcTrieIPMatcherTest, ValidPrefixLengths) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> ranges;
...
TEST_F(LcTrieIPMatcherTest, SingleHostRange) {
...
TEST_F(LcTrieIPMatcherTest, SingleIPv6HostRange) {
...
TEST_F(LcTrieIPMatcherTest, LargeNumberOfRanges) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> ranges;

  // Create 100 ranges to test LC Trie performance.
  for (int i = 0; i < 100; ++i) {
...
TEST_F(LcTrieIPMatcherTest, OverlappingRanges) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> ranges;
  ...
  *ranges.Add() = createCidrRange("192.168.1.100", 32); // Single host in subset.
  ...
  // Validates overlapping ranges LC Trie creation.
  EXPECT_NE(matcher, nullptr);
}

// Test mixed IPv4 and IPv6 ranges.
TEST_F(LcTrieIPMatcherTest, MixedIPv4IPv6Ranges) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> ranges;
  ...
  *ranges.Add() = createCidrRange("fe80::", 10);
  ...
  // Validates mixed IPv4/IPv6 LC Trie creation.
  EXPECT_NE(matcher, nullptr);
}

// Test boundary conditions.
TEST_F(LcTrieIPMatcherTest, BoundaryConditions) {
...
TEST_F(LcTrieIPMatcherTest, ExtractIpAddressNull) {
  auto range = createCidrRange("192.168.1.0", 24);
  IPMatcher matcher(range, IPMatcher::ConnectionRemote);
