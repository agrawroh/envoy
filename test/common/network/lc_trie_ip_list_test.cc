// Comprehensive tests for LC Trie-based IP list implementation.
...
class LcTrieIpListTest : public testing::Test {
protected:
...
TEST_F(LcTrieIpListTest, EmptyIpListCreation) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> empty_ranges;

  auto result = LcTrieIpList::create(empty_ranges);
...
TEST_F(LcTrieIpListTest, MultipleIPv4Ranges) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> ranges;
...
TEST_F(LcTrieIpListTest, InvalidCidrRanges) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> ranges;
...
TEST_F(LcTrieIpListTest, SingleIPv6Range) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> ranges;
...
TEST_F(LcTrieIpListTest, MixedIPv4IPv6Ranges) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> ranges;
  *ranges.Add() = createCidrRange("192.168.1.0", 24);
  *ranges.Add() = createCidrRange("2001:db8::", 32);
...
TEST_F(LcTrieIpListTest, LargeNumberOfRanges) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> ranges;

  // Create 1000 ranges to test LC Trie performance.
...
TEST_F(LcTrieIpListTest, NonIpAddressTypes) {
  Protobuf::RepeatedPtrField<envoy::config::core::v3::CidrRange> ranges;
  *ranges.Add() = createCidrRange("192.168.1.0", 24);
