...
public:
  ...
  void testAutoSniOptions(absl::optional<envoy::config::core::v3::UpstreamHttpProtocolOptions> dummy_option, Envoy::Http::TestRequestHeaderMapImpl& headers, std::string server_name = "host") {
