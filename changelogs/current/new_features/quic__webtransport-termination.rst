...
``wt-protocol`` response header. Sessions are bounded per connection and reported under the
``webtransport`` stats sub-scope. This is gated behind the runtime guard
